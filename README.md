...
Logic is how you make sense of observations, and mathematics is how you quantify them. Thus, it isn't that the universe is paradoxical, we are just using the wrong tool to understand it. How do we know this? We can use a formal system under classical reasoning to derive a universal model in which both quantum and relativistic phenomena share a common mechanism. 
